...
## MACHINE LEARNING + Fantasy Premier league ([@fpl__ai](ht
...
The **reason for this approach is a lot of players don’t play games at all** and just predicting the points of all the players directly means our target column will have many **0’s which will strongly affect the quality of our regression model.**<br>
